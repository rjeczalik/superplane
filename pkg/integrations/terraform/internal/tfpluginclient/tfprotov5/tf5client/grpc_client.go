...
import (
	...
	"github.com/superplanehq/superplane/pkg/integrations/terraform/internal/tfpluginclient/tfprotov5/internal/fromproto"
	"github.com/superplanehq/superplane/pkg/integrations/terraform/internal/tfpluginclient/tfprotov5/internal/tfplugin5"
	"github.com/superplanehq/superplane/pkg/integrations/terraform/internal/tfpluginclient/tfprotov5/internal/toproto"
...
func (c *GRPCClient) GenerateResourceConfig(ctx context.Context, req *tfprotov5.GenerateResourceConfigRequest) (*tfprotov5.GenerateResourceConfigResponse, error) {
	resp, err := c.client.GenerateResourceConfig(ctx, &tfplugin5.GenerateResourceConfig_Request{
		TypeName: req.TypeName,
		State:    toproto.DynamicValue(req.State),
	})
	if err != nil {
		return nil, err
	}
	diags, err := fromproto.Diagnostics(resp.GetDiagnostics())
	if err != nil {
		return nil, err
	}
	return &tfprotov5.GenerateResourceConfigResponse{
		Config:      fromproto.DynamicValue(resp.GetConfig()),
		Diagnostics: diags,
	}, nil
}
