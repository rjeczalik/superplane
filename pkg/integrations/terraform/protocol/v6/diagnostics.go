...
func DiagnosticsFromTFProto(diags []*tfprotov6.Diagnostic) []runtime.ProviderDiagnostic {
	if len(diags) == 0 {
		return nil
	}
...
func DiagnosticFromTFProto(diag *tfprotov6.Diagnostic) runtime.ProviderDiagnostic {
	if diag == nil {
...
func severityFromTFProto(severity tfprotov6.DiagnosticSeverity) runtime.DiagSeverity {
	switch severity {
